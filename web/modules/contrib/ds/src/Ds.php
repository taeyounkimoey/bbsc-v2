...
class Ds {
   ...
   */
  public static function getFields(string $entity_type) {
   ...
   *   Field instance.
   */
  public static function getFieldInstance(string $key, array $field, EntityInterface $entity, string $view_mode, EntityDisplayInterface $display, array $build = []) {
    $configuration = [
      'field' => $field,
      'field_name' => $key,
      'entity' => $entity,
   ...
   *
   * @return \Drupal\Core\Entity\Display\EntityDisplayInterface|\Drupal\Core\Entity\EntityInterface|bool
   *   The display.
   */

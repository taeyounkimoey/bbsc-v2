...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.multiSelect = {
    attach: function (context) {
      var $submit = $(once('multiselect', '.js-form-type-multiselect', context)).parents('form').find('.form-submit');
      var $multiselect = $(once('multiselect', 'select.multiselect-available', context));
      var $multiselectAvailable = $(once('multiselectAvailable', 'select.multiselect-available', context));
      var $multiselectSelected = $(once('multiselectSelected', 'select.multiselect-selected', context));
      var $multiselectAdd = $(once('multiselectAdd', 'li.multiselect-add', context));
      var $multiselectRemove = $(once('multiselectRemove', 'li.multiselect-remove', context));
      ...
      $(once('multiselect', '.action-save.quickedit-button')).click(function(){
        $('select.multiselect-selected').selectAll();
      });
